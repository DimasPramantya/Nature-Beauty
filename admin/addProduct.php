    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-8 d-flex justify-content-center">
                <form action="../phpHandler/addProduct.php" method="post" class="w-75" enctype="multipart/form-data">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label for="size" class="col-sm-3 col-form-label font-roboto color-283618 font-size-18">Stock</label>
                        <div class="col-sm-9">
